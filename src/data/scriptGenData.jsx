  ...
  flowSteps: [
    {
      ...
      post: '任务就绪（task_sqt_script_gen.md）+ 4 Gate PASS', edge: '输入就绪',
    ...
    },
    {
      ...
      post: '12 个 fc{nn}_{domain}.feature（428 Scenario Outline）', edge: 'FUNC 完成',
      why: '大域先行，按功能域分文件',
    },
    {
      ...
      post: 'fc_if_integration.feature + fc_nfr.feature', edge: '翻译完成',
    ...
    },
    {
      ...
      post: 'step_catalogue.yaml（362）+ gen_code_server.py', edge: '工具就绪',
