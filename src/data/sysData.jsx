...
const sysChapter = {
  ...
  io: {
    ...
    pipeline: [
      ...
      { seg: 'output', label: 'sys-req-*.md (374 SR)' },
    ],
  ...
  samples: [
    {
      ...
      title: '系统应支持接收平台下发的控车指令，5 秒内执行并回执',
      fields: [
        { k: '来源', v: 'REQ-F-000001（PRD 远程控车条目）' },
        { k: '分类', v: 'F（功能）· 编号 SR-F-000001' },
        { k: '可验证', v: '可通过平台下发指令，观察回执时间 ≤5s' },
      ],
    },
    {
      id: 'SR-H-001', badges: [{ kind: 'blue', text: '硬件 H' }], meta: 'H51 之一',
      title: '系统休眠功耗应 ≤3mA（ACC OFF 且无上报任务时）',
      fields: [
        { k: '来源', v: 'REQ-H-000051（PRD 硬件条目 + CLQ-0001 答案）' },
        { k: '分类', v: 'H（硬件）· 编号 SR-H-000001' },
        { k: '可验证', v: '可测量休眠电流验证' },
      ],
    },
    {
      id: 'SR-R-001', badges: [{ kind: 'amber', text: '法规 R' }], meta: 'R14 之一',
      title: '系统应满足 GB_17761-2024 北斗定位功能异常自检要求',
      fields: [
        { k: '来源', v: '02法规要求 GB_17761-2024 §6.6.3' },
        { k: '分类', v: 'R（法规）· 编号 SR-R-000001' },
        { k: '可验证', v: '认证检测模拟异常场景验证' },
      ],
    },
  ],
