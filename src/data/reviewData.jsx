...
const reviewChapter = {
  ...
  flowSteps: [
    ...
    },
    {
      ...
      post: 'feedback_candidate（UF 候选）+ 推荐命令', edge: '候选转正式',
    ...
    },
    {
      ...
      post: 'REVIEW-{STAGE}-{YYYY}-{NNN}.md + SIGNOFF.md', edge: '等待人工',
      why: '签名栏 AI 不得填写',
